...
using VideoShare.ViewModels.Account;
  ...
  public class AccountController : Controller
  {
    ...
    public async Task<IActionResult> Register(Register_vm model)
    {
      if (ModelState.IsValid)
      {
        ...
        {
          ModelState.AddModelError("Email", $"Email address of {model.Email} is taken. Try using another email address");
          return View(model);
        }
        ...
        await
          _userManager.AddToRoleAsync(userToAdd, SD.UserRole);
